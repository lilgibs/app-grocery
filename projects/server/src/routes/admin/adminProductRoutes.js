...
router.put('/:productId',
  ...
  check('product_name').notEmpty().withMessage('Product name is required'),
  check('product_description').notEmpty().withMessage('Product description is required').isLength({ max: 250 }).withMessage('Product description can only be a maximum of 250 characters'),
