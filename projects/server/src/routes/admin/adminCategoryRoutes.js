...
router.put("/categories/:categoryId", upload.single("product_category_image"), check("product_category_name").notEmpty().withMessage("Category name is required"), adminCategoryController.updateCategory);
