...
router.post("/adminlogin", [body("email").isEmail().withMessage("Must be a valid e-mail address."), body("password").isLength(3).withMessage("Password must be longer than 2 characters.")], adminAuthController.adminLogin);
...
router.post(
  ...
  [
    ...
    body("password").isLength(3).withMessage("Password must be longer than 2 characters."),
